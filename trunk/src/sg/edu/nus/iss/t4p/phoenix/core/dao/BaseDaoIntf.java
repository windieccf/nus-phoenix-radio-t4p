...
public interface BaseDaoIntf <T extends BaseEntity> {
	 ...
	 * method in it!
	 */
	public abstract T createValueObject();
	 ...
	 */
	public abstract T getObject(String id)	throws NotFoundException, SQLException;
	 ...
	 */
	public abstract void load(T valueObject)	throws NotFoundException, SQLException;
	 ...
	 *            Primary-key field must be set for this to work properly.
	 */
	public abstract void merge(T valueObject)throws NotFoundException, SQLException;
	 ...
	 *            Primary-key field must be set for this to work properly.
	 */	
	public abstract void remove(T valueObject)throws NotFoundException, SQLException;
